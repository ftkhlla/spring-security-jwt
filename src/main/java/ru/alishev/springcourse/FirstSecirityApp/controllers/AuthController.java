...
import ru.alishev.springcourse.FirstSecirityApp.dto.AuthenticationDTO;
import ru.alishev.springcourse.FirstSecirityApp.dto.PersonDTO;
...
import ru.alishev.springcourse.FirstSecirityApp.services.RegistrationService;
import ru.alishev.springcourse.FirstSecirityApp.util.PersonValidator;
...
public class AuthController {
    ...
    public Map<String, String> performLogin(@RequestBody AuthenticationDTO authenticationDTO){
        ...
        try {
            ...
            return Map.of("message", "Incorrect credetials");
        }
